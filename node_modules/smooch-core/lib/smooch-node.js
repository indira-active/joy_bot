...
var Smooch = exports.Smooch = function (_SmoochBase) {
    ...
    function Smooch() {
        ...
        var isAccountScope = _this.scope === 'account';

        _this.menu = new _menu.MenuApi(_this.serviceUrl, _this.authHeaders, _this.headers, isAccountScope, _this.httpAgent);
        _this.webhooks = new _webhooks.WebhooksApi(_this.serviceUrl, _this.authHeaders, _this.headers, isAccountScope, _this.httpAgent);
        _this.attachments = new _attachments.AttachmentsApi(_this.serviceUrl, _this.authHeaders, _this.headers, isAccountScope, _this.httpAgent);

        if (_this.scope === 'account') {
            _this.integrations = new _integrations.IntegrationsApi(_this.serviceUrl, _this.authHeaders, _this.headers, true, _this.httpAgent);
            _this.apps = new _apps.AppsApi(_this.serviceUrl, _this.authHeaders, _this.headers, true, _this.httpAgent);
            _this.appUsers = new _appUsers.AppUsersApi(_this.serviceUrl, _this.authHeaders, _this.headers, true, _this.httpAgent);
            _this.conversations = new _conversations.ConversationsApi(_this.serviceUrl, _this.authHeaders, _this.headers, true, _this.httpAgent);
            _this.stripe = new _stripe.StripeApi(_this.serviceUrl, _this.authHeaders, _this.headers, true, _this.httpAgent);
        } else {
