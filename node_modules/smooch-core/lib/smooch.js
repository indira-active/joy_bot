...
var Smooch = exports.Smooch = function Smooch() {
    ...
    this.appUsers = new _appUsers.AppUsersApi(this.serviceUrl, this.authHeaders, this.headers, false, this.httpAgent);
    this.conversations = new _conversations.ConversationsApi(this.serviceUrl, this.authHeaders, false, this.headers, this.httpAgent);
    this.stripe = new _stripe.StripeApi(this.serviceUrl, this.authHeaders, this.headers, false, this.httpAgent);
